...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'misd_guzzle.data_collector' => 'getMisdGuzzle_DataCollectorService',
            ...
            'upc.client' => 'getUpc_ClientService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/cdcooksey/Sites/shopping-list/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Users/cdcooksey/Sites/shopping-list/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'flapp', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'flapp', 'password' => 'flapp', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_31629cbc1d3eca6b2f1e1e25f36a8e75c68d573ecd5439b189f75e6c4d4acb96');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_31629cbc1d3eca6b2f1e1e25f36a8e75c68d573ecd5439b189f75e6c4d4acb96');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_31629cbc1d3eca6b2f1e1e25f36a8e75c68d573ecd5439b189f75e6c4d4acb96');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Users/cdcooksey/Sites/shopping-list/src/Cooksey/FlappBundle/Entity')), 'Cooksey\\FlappBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('CookseyFlappBundle' => 'Cooksey\\FlappBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/Users/cdcooksey/Sites/shopping-list/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Users/cdcooksey/Sites/shopping-list/app/Resources');
    }
    ...
    {
        $this->services['guzzle.service_builder'] = $instance = call_user_func(array('Guzzle\\Service\\Builder\\ServiceBuilder', 'factory'), '/Users/cdcooksey/Sites/shopping-list/app/config/webservices.json');
    ...
    {
        return $this->services['misd_guzzle.cache.doctrine.filesystem.adapter'] = new \Doctrine\Common\Cache\FilesystemCache('/Users/cdcooksey/Sites/shopping-list/app/cache/dev/guzzle/');
    }
    ...
    /**
     * Gets the 'misd_guzzle.data_collector' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Misd\GuzzleBundle\DataCollector\GuzzleDataCollector A Misd\GuzzleBundle\DataCollector\GuzzleDataCollector instance.
     */
    protected function getMisdGuzzle_DataCollectorService()
    {
        return $this->services['misd_guzzle.data_collector'] = new \Misd\GuzzleBundle\DataCollector\GuzzleDataCollector($this->get('misd_guzzle.log.adapter.array'));
    }
    ...
    {
        $this->services['misd_guzzle.param_converter'] = $instance = new \Misd\GuzzleBundle\Request\ParamConverter\GuzzleParamConverter3x();

        $instance->registerClient('upc.client', $this->get('upc.client'));
    ...
    {
        return $this->services['misd_guzzle.response.parser.fallback'] = call_user_func(array('Guzzle\\Service\\Command\\OperationResponseParser', 'getInstance'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Users/cdcooksey/Sites/shopping-list/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/cdcooksey/Sites/shopping-list/app/cache/dev/profiler', '', '', 86400), $a);
        ...
        $instance->add($d);
        $instance->add($this->get('misd_guzzle.data_collector'));
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Users/cdcooksey/Sites/shopping-list/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Users/cdcooksey/Sites/shopping-list/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/cdcooksey/Sites/shopping-list/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Users/cdcooksey/Sites/shopping-list/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/cdcooksey/Sites/shopping-list/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/cdcooksey/Sites/shopping-list/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Users/cdcooksey/Sites/shopping-list/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Users/cdcooksey/Sites/shopping-list/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Users/cdcooksey/Sites/shopping-list/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Users/cdcooksey/Sites/shopping-list/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Users/cdcooksey/Sites/shopping-list/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Users/cdcooksey/Sites/shopping-list/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Users/cdcooksey/Sites/shopping-list/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Users/cdcooksey/Sites/shopping-list/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Users/cdcooksey/Sites/shopping-list/src/Cooksey/FlappBundle/Resources/views', 'CookseyFlapp');
        $instance->addPath('/Users/cdcooksey/Sites/shopping-list/vendor/misd/guzzle-bundle/Misd/GuzzleBundle/Resources/views', 'MisdGuzzle');
        $instance->addPath('/Users/cdcooksey/Sites/shopping-list/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/Users/cdcooksey/Sites/shopping-list/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Users/cdcooksey/Sites/shopping-list/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Users/cdcooksey/Sites/shopping-list/app/Resources/views');
        $instance->addPath('/Users/cdcooksey/Sites/shopping-list/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
     ...
     * @return Guzzle\Service\Client A Guzzle\Service\Client instance.
     */
    protected function getUpc_ClientService()
    {
        $this->services['upc.client'] = $instance = new \Guzzle\Service\Client('http://api.upcdatabase.org/json/');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b501740f4612ec1f4426b1812d450fed0d8fd111');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/cdcooksey/Sites/shopping-list/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Users/cdcooksey/Sites/shopping-list/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/cdcooksey/Sites/shopping-list/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Users/cdcooksey/Sites/shopping-list/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/cdcooksey/Sites/shopping-list/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/cdcooksey/Sites/shopping-list/app/cache/dev',
            'kernel.logs_dir' => '/Users/cdcooksey/Sites/shopping-list/app/logs',
            'kernel.bundles' => array(
                ...
                'CookseyFlappBundle' => 'Cooksey\\FlappBundle\\CookseyFlappBundle',
            ...
            'database_name' => 'flapp',
            'database_user' => 'flapp',
            'database_password' => 'flapp',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => 'b501740f4612ec1f4426b1812d450fed0d8fd111',
            ...
            'debug.container.dump' => '/Users/cdcooksey/Sites/shopping-list/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => 'b501740f4612ec1f4426b1812d450fed0d8fd111',
            ...
            'session.save_path' => '/Users/cdcooksey/Sites/shopping-list/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Users/cdcooksey/Sites/shopping-list/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/Users/cdcooksey/Sites/shopping-list/app/cache/dev/profiler',
            ...
            'router.resource' => '/Users/cdcooksey/Sites/shopping-list/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/cdcooksey/Sites/shopping-list/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Users/cdcooksey/Sites/shopping-list/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Users/cdcooksey/Sites/shopping-list/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Users/cdcooksey/Sites/shopping-list/app/../web',
            'assetic.write_to' => '/Users/cdcooksey/Sites/shopping-list/app/../web',
            'assetic.variables' => array(

            ),
            'assetic.java.bin' => '/usr/bin/java',
            'assetic.node.bin' => '/usr/bin/node',
            'assetic.ruby.bin' => '/Users/cdcooksey/.rvm/rubies/ruby-1.9.3-p429/bin/ruby',
            'assetic.sass.bin' => '/Users/cdcooksey/.rvm/gems/ruby-1.9.3-p429/bin/sass',
            ...
            'doctrine.orm.proxy_dir' => '/Users/cdcooksey/Sites/shopping-list/app/cache/dev/doctrine/orm/Proxies',
            ...
            'doctrine_migrations.dir_name' => '/Users/cdcooksey/Sites/shopping-list/app/DoctrineMigrations',
            ...
            'guzzle.service_builder.configuration_file' => '/Users/cdcooksey/Sites/shopping-list/app/config/webservices.json',
            'misd_guzzle.cache.filesystem.path' => '/Users/cdcooksey/Sites/shopping-list/app/cache/dev/guzzle/',
