...
namespace Proxies\__CG__\Cooksey\FlappBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Product extends \Cooksey\FlappBundle\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'upc', 'name', 'price', 'updatedAt', 'createdAt');
        }
